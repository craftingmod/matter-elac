...
import { clampSWVersion, fetchCGIInfo, hash6, type CGIInfo } from "../elac/ElacFetch.ts"
import {
  createKeypadServer,
...
export async function createRootNode(elacClient: A101gClient, cgiInfo: CGIInfo) {
  // Create Servers
  const {
    MuteServer,
    VolumeServer,
